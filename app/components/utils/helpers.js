...
const helper = {
  ...
  postSaved: function(savedArticle) {
    console.log("in helper", savedArticle)
    return axios.post("/api/saved", {article: savedArticle });
  },

  postUser: function(user) {
    console.log("in helper", user)
    return axios.post("/api/users", {user: user});

  //  return("hello");
  //  return axios.post("/api/saved", {user: user});
  },

  postUserInDb: function(user) {
    console.log("in helper", user)
    return axios.post("/put_newuser_in_db", {user: user});
